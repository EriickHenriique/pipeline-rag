...
class FinancialAnalysis(BaseModel):
    ...
    source: list[Source] = Field(default_factory=list, description="Lista de fontes dos KPIs incluídos na resposta, contendo os identificadores dos chunks de onde os KPIs foram extra ídos, as páginas dos relatórios e as seções dos relatórios de onde os chunks foram extraídos.")
