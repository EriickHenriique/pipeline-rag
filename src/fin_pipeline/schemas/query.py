...
class RetrievalFilters(BaseModel):
    ...
    sections: list[str] = Field(default_factory=list, description="Lista de seções do relatório para filtrar os chunks, ex: 'Demonstração de Resultados', 'Balanço Patrimonial'")
